...
$query="UPDATE `scheme_table` SET `scheme_name` = '$name',`ration_card` = '$id2',`health_card` = '$id5',`income_certificate` = '$id3',`pregnant` = '$id7',`opd` = '$id8',`voter_card` = '$id9',`rural_area` = '$id10',`pan_card` = '$id6',`urban_area` = '$id11',`satbara_utara` = '$id4' WHERE `scheme_table`.`index` = 0
";
$con=mysqli_query($conn,$query);

$python = `python scheme.py`;
   ...
   <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <h3 class="p-2 font-weight-bold">Scheme</h3></div>
          <!-- Topbar Search -->
    ...
    <section class="p-3">  
      <?php $query="SELECT schemename,scheme_description from scheme_view";
         $con=mysqli_query($conn,$query);
           while($data=mysqli_fetch_array($con)){
              ...
              echo  "<div class='card-body'>  
                      ...
                      <a href='3.1-scheme-sahayak.php?sname=".$data['schemename']." ' class='btn btn-primary col-lg-2 col-md-2 col-sm-auto' style='left: 800px;'>detailes
                      </a>
                    </div>
                  </div>";
               }?>
