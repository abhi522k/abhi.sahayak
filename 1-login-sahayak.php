...
<body class="">
                ...
                <div class="p-5"> 
                 ...
                 <form class="form" action="c.php" id="form" method="post"> 
                    <div class="form-group">
                      <input  id="aadharcardno" name="user" type="number" class="form-control" style="width: 300px;" autocomplete="off" placeholder="Enter User id...">
                  ...
                  <div class="text-center">
                    <a class="small" href="sahayak/loginDoctor.php">Login as Doctor</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script type="text/javascript">
        var myInput = document.getElementById("aadharcardno");
...
function validate() {
  ...
  if (count < 12) {
    this.setCustomValidity('Please enter 12 digit aadhar number');
  } else if (count > 12) {
    this.setCustomValidity('Aadhar number cannot be more than 12 digit');
  }
}
   </script>
