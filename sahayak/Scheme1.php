				...
				session_start();
				  ...
				  if($_SERVER["REQUEST_METHOD"] == "POST")
				  {
				   // username and password sent from form 
					 ...
					 $sql="SELECT patient_id FROM patients WHERE patient_id='$p_id'";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
					...
					<a class="nav-link active" data-bs-hover-animate="flash" href="AddPatient.html"><i class="fas fa-plus"></i><span>Add Patient</span></a>
					...
					<a class="nav-link active" data-bs-hover-animate="flash" href="Scheme.php"><i class="fas fa-clipboard-list"></i><span>Schemes</span></a>
					  <a
                                class="nav-link active" data-bs-hover-animate="flash" href="index.html"><i class="fas fa-calendar-check"></i><span>Appointments</span></a>
								</li>
                </ul>
        ...
        <div id="content">
            <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    <h1 style="font-family: Bitter, serif;">Schemes</h1>
                    <ul class="nav navbar-nav flex-nowrap ml-auto">
					<form class="form mr-auto w-100 mt-2 mb-2 navbar-search">
					<div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Search for scheme ..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <!-- Topbar Search -->
			...
			<section class="p-3">  
				...
				<?php
					$sql = "SELECT scheme_name,scheme_description FROM scheme_table";
					$result = mysqli_query($conn,$sql);
            ...
            <div class="card-body">
             ...
             <a href="SchemeDetails.php" class="btn btn-primary col-lg-2 col-md-2 col-sm-auto" style="left: 800px;">Details</a></div>
