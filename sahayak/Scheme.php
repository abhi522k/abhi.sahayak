				...
				session_start();
				  ...
				  if($_SERVER["REQUEST_METHOD"] == "POST")
				  {
				   // patient id  sent from form 
					 $s_name=mysqli_real_escape_string($conn,$rows['scheme_name']); 
				 
					 $sql="SELECT scheme_name FROM schme_table WHERE scheme_name='$s_name'";
					...
					if($count==1)
					{
					 ...
					 $_SESSION['scheme_user']=$s_name;
					
					 header("location: SchemeDetails.php");
					}
					if($count==0)
					{
...
<body id="page-top">
    <div id="wrapper">
       <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" >
            <div class="container-fluid d-flex flex-column p-0">
                <div class="dropdown show no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="true" href="profile.php"><img class="border rounded-circle img-profile" src="assets/img/IMG_9325.JPG" style="width: 80px;height: 81px;margin-bottom: 7px;margin-left: 20px;"><h1 style="color: rgb(249,250,251);font-size: 20px;"><a href="profile.html" style="color: rgb(251,251,252);">Dr. Sharma</a></h1>
                    <h1
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <h1 style="font-family: Bitter, serif;">Scheme</h1>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
          ...
          <?php
					$sql = "SELECT scheme_name,scheme_description FROM scheme_table WHERE 1";
					$result = mysqli_query($conn,$sql);
			...
			<div class="card shadow ml-5 mr-5 mt-3">
			 <div class="card-header">
                  ...
                  <h4 class="font-weight-bold text-primary"><?php echo $rows['scheme_name']; ?></h4>
				       
					<?php
						$_SESSION['scheme_name'] = $rows['scheme_name'];
					?>
				</div>
				  
				<div class="card-body">
              <h6 class=""><?php echo $rows['scheme_description']; ?></h6>
				 
             <a href="SchemeDetails.php" class="btn btn-primary col-lg-2 col-md-2 col-sm-auto" style="left: 800px;">Details</a>
