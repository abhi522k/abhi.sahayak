...
<body>
  ...
  height: 15rem;"></div>
              ...
              <div class="col-lg-6">
                <div class="p-5"> 
                  <div class="imgsetting d-block m-auto"><i class="fa fa-user-md fa-3x mb-4"></i></div>

                 <form class="form" action="d.php" id="form" method="post"> 
                    <div class="form-group">
                      <input  id="aadharcardno" name="user" type="number" class="form-control" style="width: 300px;" autocomplete="off" placeholder="Enter doctor id...">
                  ...
                  <div class="text-center">
                    <a class="small" href="1-login-sahayak.php">Login as User</a>
                  </div>
                </div>
              </div>
